  ...
  return userData && (
    <div className='max-w-lg flex flex-col gap-2 text-sm mt-6'>
      ...
      <div className='mt-10'>
        {
          isEdit ?
            <button className='border font-medium border-primary px-8 py-2 rounded-full hover:bg-primary transition-all duration-400 hover:text-white' onClick={updateUserProfileData}>Save information</button> :
